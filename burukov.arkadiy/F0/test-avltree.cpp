...
BOOST_AUTO_TEST_CASE(pushRvalueMovesValue)
{
  burukov::AVLTree< int, std::string > t;
  std::string val = "test";
...
BOOST_AUTO_TEST_CASE(atReturnsCorrectValue)
{
  burukov::AVLTree< int, std::string > t;
  t.push(1, "one");
  t.push(2, "two");
...
BOOST_AUTO_TEST_CASE(atAllowsModification)
{
  burukov::AVLTree< int, std::string > t;
  t.push(1, "one");
  t.at(1) = "ONE";
...
BOOST_AUTO_TEST_CASE(constAtWorksOnConstObject)
{
  burukov::AVLTree< int, std::string > t;
  t.push(1, "one");
  const auto &ct = t;
...
BOOST_AUTO_TEST_CASE(dropRemovesLeafNode)
{
  burukov::AVLTree< int, std::string > t;
  t.push(2, "two");
  t.push(1, "one");
...
BOOST_AUTO_TEST_CASE(dropThrowsOnMissingKey)
{
  burukov::AVLTree< int, std::string > t;
...
BOOST_AUTO_TEST_CASE(traversalInOrder)
{
  ...
  int i = 0;
  t.traverseInOrder([&](const int &key, const std::string &) {
