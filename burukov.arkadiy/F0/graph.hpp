...
namespace burukov
{
  ...
  inline burukov::RecommendationGraph::GraphNode *
  burukov::RecommendationGraph::findNode(const std::string &title)
  {
  ...
  inline const burukov::RecommendationGraph::GraphNode *
  burukov::RecommendationGraph::findNode(const std::string &title) const
  {
  ...
  inline burukov::RecommendationGraph::GraphNode &
  burukov::RecommendationGraph::getOrCreateNode(const std::string &title)
  {
  ...
  inline void burukov::RecommendationGraph::addUndirectedEdge(
  ...
  inline void burukov::RecommendationGraph::addCoLend(
  ...
  inline void burukov::RecommendationGraph::normalizeDirectEdges()
  {
  ...
  inline void burukov::RecommendationGraph::addTransitiveEdges(double weight)
  {
    for (auto itA = nodes_.begin(); itA != nodes_.end(); ++itA) {
  ...
  inline void burukov::RecommendationGraph::calculateScores(
    double transitiveWeight)
  {
  ...
  burukov::RecommendationGraph::getRecommendations(
    const std::string &book, size_t k) const
  {
    ...
    result.sort([](const std::pair< std::string, double > &a,
